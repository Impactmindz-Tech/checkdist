...
function ChatAndSupport() {
  ...
  return (
    ...
    <div className="mt-10">
      <button className="border border-gray-900 text-gray-900 py-4 font-bold rounded-md w-full">
        Cancel
      </button>

      <a href={chatSupport} className="w-full block my-4">
        <button className="bg-gray-900 text-white py-4 font-bold rounded-md w-full">
          Still Need Help?
        </button>
      </a>
    </div>
