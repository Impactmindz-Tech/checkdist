  ...
  return (
    <div className="p-4 sm:p-0 sm:mt-2">
      <div className="BoxShadowLessRounded pb-2">
        ...
        <div className="borderTopBottom flex justify-between m-auto w-[94%] py-2 text-grey-800 sm:text-xs">
        ...
        <button
          className={`flex justify-center sm:text-xs items-center py-3 gap-2 rounded w-[94%] my-2 m-auto ${
            disablePay
