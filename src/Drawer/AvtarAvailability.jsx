...
import {
  avtarAvailableApi,
  getAvailableApi,
} from "@/utills/service/avtarService/AddExperienceService";
...
const AvtarAvailability = ({ avalibility, setAvaability }) => {
  ...
  const validate = () => {
    ...
    if (!formValues.timeZone)
      newErrors.timeZone = "Time Zone field is required.";
